...
# Qwen3-VL-32B-Instruct 4卡启动脚本

set -e

MAX_MODEL_LEN=${1:-8192}
PORT=${2:-8003}
MODEL_PATH="/models/Qwen/Qwen3-VL-32B-Instruct"
LOG_FILE="/home/bes/work/vllm-project/vllm_serve_qwen3_vl_32b_4npu.log"

echo "========================================"
echo "启动 Qwen3-VL-32B-Instruct 服务 (4卡)"
echo "========================================"

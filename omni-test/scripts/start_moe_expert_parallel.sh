...
# MOE专家并行启动脚本 - 启用专家并行和共享专家DP
# 用途: 测试专家并行对内存和性能的影响
# 使用方法: bash start_moe_expert_parallel.sh [max_model_len] [port]
...
LOG_FILE="/home/bes/work/vllm-project/vllm_serve_moe_expert_parallel.log"

echo "========================================"
echo "启动 MOE 模型 - 专家并行配置"
echo "========================================"
...
echo ""
echo "参数效果说明:"
echo "  - Expert Parallel: 专家分布在不同NPU,减少内存复制"
echo "  - Shared Expert DP: 共享专家数据并行,进一步优化内存"
echo "  - 预期内存减少: 30-50%"
echo "  - 预期性能提升: 15-25%"
echo "========================================"
